...
class LoginForm(forms.Form,FormMixin):
    ...
    password=forms.CharField(max_length=20,min_length=6,error_messages={'max_length':'密码最多不能超过20个字符！','min_length':'密码不能少于6个字符'})
...
class RegisterForm(forms.Form,FormMixin):
    ...
    password1 = forms.CharField(max_length=20, min_length=6,error_messages={'max_length': '密码最多不能超过20个字符！', 'min_length': '密码不能少于6个字符'})
    password2 = forms.CharField(max_length=20, min_length=6,error_messages={'max_length': '密码最多不能超过20个字符！', 'min_length': '密码不能少于6个字符'})
